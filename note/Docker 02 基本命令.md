https://www.kuangstudy.com/bbs/1475666055677751297
...
```shell
PS D:\Docker\test> docker images --help
...
```shell
PS D:\Docker\test> docker ps --help
...
```shell
PS D:\Docker\test> docker version
Client:
...
Server:
 ...
 Name: docker-desktop
 ID: CNBZ:3OSJ:7AVP:S2EC:HMVA:H6WH:4TD2:ZDZ7:KUZU:AYRJ:HE34:YXNH
